...
const AdminBody = () => {
  ...
  const postBooking = () => {
    ...
    for (const [key, value] of Object.entries(addedFoodItems)) {
      console.log(key, value);
      axios.put(`${foodandbeweragesUrl}/update/quantityavailable/${key}/${value}`).then((respomse)=>console.log(respomse.data))
    }
